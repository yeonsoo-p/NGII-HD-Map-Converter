...
def _add_view_keys(plotter: pv.Plotter) -> None:
    def _view_2d() -> None:
...
class A2Viz:
    ...
    def _add_extras(self, plotter: pv.Plotter) -> None:
    ...
    def show(self) -> None:
        ...
        def _on_left_press(_obj: Any, _event: str) -> None:
            ...
            plotter.add_text(text, position="upper_right", name="link_id_text", font_size=12)
...
class SegmentsViz(A2Viz):
    ...
    def __init__(self, shp_dir: Path) -> None:
        ...
        self.palette = _bundle_colors(int(self.bundle_ids.max()) + 1)
